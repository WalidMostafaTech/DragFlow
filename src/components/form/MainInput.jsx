...
const MainInput = ({
  ...
  return (
    <div className="space-y-2">
      {label && (
        <label htmlFor={name} className="text-primary text-lg inline-block">
          {label}
        </label>
      )}
      ...
      {type === "textarea" && (
        <Textarea
          ...
          disabled={disabled}
          className=" bg-white text-black min-h-26 focus-visible:border-primary focus-visible:ring-primary/50 max-h-60"
        />
      )}
      ...
      {type !== "textarea" && type !== "select" && type !== "file" && (
        <div className="relative">
          ...
          <Input
            ...
            placeholder={placeholder}
            disabled={disabled}
            className={`bg-white text-black h-12 focus-visible:border-primary focus-visible:ring-primary/50 
                ${icon ? "ps-10" : ""}
                ${isPassword ? "pe-10" : ""}`}
          />
